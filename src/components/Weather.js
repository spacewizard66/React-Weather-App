...
function Weather() {
	...
	const url = `https://api.openweathermap.org/data/2.5/weather?q=${location}&units=metric&appid=4ebb9418ca605fa1931880e565ec065c`;
	...
	return (
		<div className="container">
            ...
            {data ? (
                data.main ? (
					<div className="main">
						<div className="location-div" id={animate ? "animate1" : ""}>
							<p className="location">{`${data.name}, ${data.sys.country}`}</p>
						</div>

						<div className="temp-div" id={animate ? "animate2" : ""}>
							<h1 className="temp">{`${select(data.main.temp)}°${unit ? "F" : "C"}`}</h1>
						</div>

						<div className="description" id={animate ? "animate3" : ""}>
							<p className="description">{`${data.weather[0].description}`}</p>
						</div>

						<div className="bottom">
							<div className="extra" id={animate ? "animate4" : ""} onAnimationEnd={() => setAnimate(false)}>
                    ...
                    <div className="main">
                        <div className="location-div" id={animate ? "animate1" : ""} onAnimationEnd={() => setAnimate(false)}>
                ...
                ! error ? (
                    ...
                    <div id={animate ? "animate1" : ""} onAnimationEnd={() => setAnimate(false)}>
